...
router.post ('/addgood', controllers.good.add)
router.post ('/removegood', controllers.good.remove)
router.post ('/findgood', controllers.good.find)
router.post ('/updategood', controllers.good.update)
